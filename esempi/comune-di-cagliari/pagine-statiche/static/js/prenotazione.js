app.controller("ctrlPrenotazione", [
  "$scope",
  "$location",
  "$anchorScroll",
  function($scope, $location, $anchorScroll) {
    ...
    this.uffici = [
      { id: 0, value: "ambiente", name: "Ambiente", enable: false },
      {
        id: 1,
        value: "edilizia-privata",
        name: "Edilizia Privata",
        enable: true
      },
    ...
    this.referenti = [
      {
        ...
        role: "Responsabile del servizio",
        disp: "Riceve lun / mar ore 9:00 - 11:00"
      },
      {
        id: 1,
        name: "Raffaele Rossi",
        role: "Tecnico di area",
        disp: "Riceve mar / mer ore 10:00 - 13:00"
      },
      {
        id: 2,
        name: "Gino Ferrari",
        role: "Funzionario tecnico",
        disp: "Riceve ven ore 14:00 - 18:00"
      },
      {
        id: 3,
        name: "Luciano Rigoletti",
        role: "Funzionario amministrativo",
        disp: "Riceve lun / mar ore 9:00 - 11:00"
      }
    ];
    ...
    this.quintoSubmit = function() {
      ...
      selfp.appuntamento_tit =
        "L'appuntamento con " +
        selfp.referenti[selfp.referente].name +
